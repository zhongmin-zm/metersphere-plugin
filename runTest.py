...
class MeterSphere:
    ...
    def update_env_1(self, project_name: str, project_id: str, env: str, env_id: str, doris_package_name: str, host_1, host_2,
                     host_3, manager_download, manager_package, doris_download, upgrade_doris_package_name, upgrade_doris_download,
        ...
        if "manager" in project_name:
            body = {
                ...
                "variables": None,
                "headers": None,
                "config": "{\"commonConfig\":{\"variables\":[{\"name\":\"DorisPackageName\",\"value\":\"" + doris_package_name + "\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":1,\"id\":\"2a4c6ba5-d4fd-860a-e120-9481a1c15efe\"},{\"name\":\"deployIP1\",\"value\":\"" + host_1+ "\",\"type\":\"CONSTANT\",\"files\":[],\"enable\":true,\"quotedData\":\"false\",\"delimiter\":\",\",\"scope\":\"api\",\"num\":3,\"id\":\"c46ea313-888e-2388-cd6e-d6ec4c49749b\"},{\"name\":\"env\",\"value\":\"SelectDB\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":4,\"id\":\"cbdec58f-11af-c89a-eb01-65fe1d0df3f2\"},{\"name\":\"agentPort\",\"value\":\"8991\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":5,\"id\":\"618432f7-2812-ca1b-f914-121547b35f8b\"},{\"name\":\"deployUser\",\"value\":\"auto\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":6,\"id\":\"ba8ff269-3ee9-7de3-1d55-eb98b2ed66aa\"},{\"name\":\"deployPassword\",\"value\":\"Cfplhys2022@\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":7,\"id\":\"cf5ee92d-e63b-abc1-cceb-4fea60d4adc9\"},{\"name\":\"managerDownload\",\"value\":\"" + manager_download + "\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":8,\"id\":\"7d6fdd35-32f5-f3ff-56a8-fd9401c50747\"},{\"name\":\"managerPackage\",\"value\":\"" + manager_package + "\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":9,\"id\":\"efb95afb-8de9-d878-b381-72954d2fa8ef\"},{\"name\":\"managerHost\",\"value\":\"" + host_1 + "\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":10,\"id\":\"012500ce-3820-e64e-d405-9a8fc039c586\"},{\"name\":\"managerPort\",\"value\":\"8006\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":11,\"id\":\"70d8e8ed-9ebd-4c69-a2dd-3274a8af6621\"},{\"name\":\"deployPath\",\"value\":\"/home/auto/zm/\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":12,\"id\":\"317d5f3e-e9c3-fa6a-c5cd-6f7701d20913\"},{\"name\":\"deployIP2\",\"value\":\"" + host_2 + "\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":13,\"id\":\"2e2c930a-23fc-bd42-c62b-0eeee707b0f8\"},{\"name\":\"dorisDownload\",\"value\":\"" + doris_download + "\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":14,\"id\":\"9d06ae77-d0fa-91f6-d382-65eb51035728\"},{\"name\":\"priorityNetworks\",\"value\":\"" + priority_network + "\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":15,\"id\":\"95eca3cc-d204-4210-7c1a-a1a58f653b94\"},{\"name\":\"upgradeDorisPackageName\",\"value\":\"" + upgrade_doris_package_name + "\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":16,\"id\":\"675db74b-03e5-9e41-2130-6262765f2a46\"},{\"name\":\"upgradeDorisDownload\",\"value\":\"" + upgrade_doris_download + "\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":17,\"id\":\"5dbe7e11-3632-59ee-7242-02a7dfd6cec2\"},{\"name\":\"upgradeManagerDownload\",\"value\":\"" + upgrade_manager_download + "\",\"type\":\"CONSTANT\",\"enable\":true,\"id\":\"0bb38615-9c47-fd71-db7f-121241533fa6\",\"scope\":\"api\",\"num\":18},{\"name\":\"upgradeManagerPackage\",\"value\":\"" + upgrade_manager_package+ "\",\"type\":\"CONSTANT\",\"enable\":true,\"id\":\"98c8afd2-e900-faaf-76d5-eeec8088d9db\",\"scope\":\"api\",\"num\":19},{\"name\":\"deployIP3\",\"value\":\"" + host_3 + "\",\"type\":\"CONSTANT\",\"enable\":true,\"id\":\"b28fc4db-87b1-1037-44ef-3c4209aec7d1\",\"scope\":\"api\",\"num\":20},{\"type\":\"CONSTANT\",\"enable\":true,\"id\":\"b28fc4db-87b1-1037-44ef-3c4209aec7d1\",\"scope\":\"api\",\"num\":21}],\"enableHost\":false,\"hosts\":[],\"requestTimeout\":60000,\"responseTimeout\":60000},\"httpConfig\":{\"socket\":\"" + host_1 + ":8006\",\"headers\":[{\"enable\":true}],\"protocol\":\"http\",\"conditions\":[{\"type\":\"NONE\",\"enable\":true,\"id\":\"34aea18d-8b63-4ef1-b191-410b38c161d8\",\"socket\":\"" + host_1 + ":8006\",\"protocol\":\"http\",\"headers\":[{\"enable\":true}],\"domain\":\"" + host_1 + "\",\"time\":1721370581010,\"details\":[{\"name\":\"\",\"value\":\"contains\",\"enable\":true}],\"[object Object]\":1}],\"cookie\":[{\"enable\":false,\"expireTime\":\"1D\"}],\"browser\":\"CHROME\",\"headlessEnabled\":true,\"isMock\":false,\"description\":\"\"},\"databaseConfigs\":[],\"tcpConfig\":{\"classname\":\"TCPClientImpl\",\"reUseConnection\":true,\"nodelay\":false,\"closeConnection\":false},\"sslConfig\":{\"entry\":[],\"files\":[]},\"postStepProcessor\":{\"jsrEnable\":true,\"scriptLanguage\":\"beanshell\"},\"authManager\":{\"hashTree\":[]},\"preProcessor\":{\"jsrEnable\":true,\"scriptLanguage\":\"beanshell\"},\"globalScriptConfig\":{\"filterRequestPreScript\":[],\"connScenarioPostScript\":false,\"connScenarioPreScript\":false,\"filterRequestPostScript\":[],\"isPostScriptExecAfterPrivateScript\":false,\"isPreScriptExecAfterPrivateScript\":false},\"assertions\":{\"duration\":{\"duration\":0},\"jsr223\":[],\"xpathType\":\"xml\",\"regex\":[],\"document\":{\"type\":\"JSON\",\"data\":{\"json\":[],\"xml\":[]},\"enable\":true},\"xpath2\":[],\"jsonPath\":[]},\"postProcessor\":{\"jsrEnable\":true,\"scriptLanguage\":\"beanshell\"},\"preStepProcessor\":{\"jsrEnable\":true,\"scriptLanguage\":\"beanshell\",\"script\":\"priorityNetworks = vars.get(\\\"priorityNetworks\\\");\\ndeployIP1 = vars.get(\\\"deployIP1\\\");\\ndeployIP2 = vars.get(\\\"deployIP2\\\");\\ndeployIP3 = vars.get(\\\"deployIP3\\\");\\n\\nlog.info(priorityNetworks);\\nif (\\\"IP\\\".equals(priorityNetworks)){\\n    log.info(\\\"111111\\\");\\n    log.info(vars.get(\\\"priorityNetworks\\\"));\\n    vars.put(\\\"priorityNetworks_1\\\", deployIP1 + \\\"/32\\\");\\n    vars.put(\\\"priorityNetworks_2\\\", deployIP2 + \\\"/32\\\");\\n    vars.put(\\\"priorityNetworks_3\\\", deployIP3 + \\\"/32\\\");\\n    \\n}else{\\n    log.info(\\\"22222\\\");\\n    vars.put(\\\"priorityNetworks_1\\\", priorityNetworks);\\n    vars.put(\\\"priorityNetworks_2\\\", priorityNetworks);\\n    vars.put(\\\"priorityNetworks_3\\\", priorityNetworks);\\n    \\n}\"}}",
                "hosts": None,
            ...
            body = {"id":env_id,"name":env,"projectId":project_id,"protocol":None,"socket":None,"domain":None,"port":None,"createUser":"admin","createTime":1721910222678,"updateTime":1722424759363,"variables":None,"headers":None,"config":"{\"commonConfig\":{\"variables\":[{\"name\":\"feIp\",\"value\":\"" + host_1 + "\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":1,\"id\":\"0ad28a27-e77d-a77b-af45-556f550006e7\"},{\"name\":\"feJdbcPort\",\"value\":\"9535\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":2,\"id\":\"72d02405-e5f4-aba7-d87e-9627885c4826\"},{\"name\":\"feHttpPort\",\"value\":\"8535\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":3,\"id\":\"57690385-93cb-c12d-4077-869fe22f4765\"},{\"name\":\"userName\",\"value\":\"root\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":4,\"id\":\"afcf5479-338c-57eb-48f5-b82049b11048\"},{\"name\":\"password\",\"value\":\"test_123\",\"type\":\"CONSTANT\",\"enable\":true,\"scope\":\"api\",\"num\":5,\"id\":\"1863bbc0-fe8f-93ff-8cad-fb386ef67067\"},{\"type\":\"CONSTANT\",\"enable\":true,\"id\":\"60cd6703-26a0-5889-b41b-67232374722d\",\"scope\":\"api\",\"num\":6}],\"enableHost\":false,\"hosts\":[],\"requestTimeout\":60000,\"responseTimeout\":60000},\"httpConfig\":{\"socket\":\"" + host_1 + ":8515/\",\"headers\":[{\"enable\":true}],\"protocol\":\"http\",\"conditions\":[{\"type\":\"NONE\",\"enable\":true,\"id\":\"5581e752-0d64-4743-a81e-9626d5e4b8cf\",\"socket\":\"" + host_1 + ":8515/\",\"protocol\":\"http\",\"headers\":[{\"enable\":true}],\"time\":1721910326490,\"details\":[{\"name\":\"\",\"value\":\"contains\",\"enable\":true}],\"domain\":\"" + host_1 + "\"}],\"cookie\":[{\"enable\":false,\"expireTime\":\"1D\"}],\"browser\":\"CHROME\",\"headlessEnabled\":true,\"isMock\":false,\"description\":\"\"},\"databaseConfigs\":[],\"tcpConfig\":{\"classname\":\"TCPClientImpl\",\"reUseConnection\":true,\"nodelay\":false,\"closeConnection\":false},\"sslConfig\":{\"entry\":[],\"files\":[]},\"postStepProcessor\":{\"jsrEnable\":true,\"scriptLanguage\":\"beanshell\"},\"authManager\":{\"hashTree\":[]},\"preProcessor\":{\"jsrEnable\":true,\"scriptLanguage\":\"beanshell\"},\"globalScriptConfig\":{\"filterRequestPreScript\":[],\"connScenarioPostScript\":false,\"connScenarioPreScript\":false,\"filterRequestPostScript\":[],\"isPostScriptExecAfterPrivateScript\":false,\"isPreScriptExecAfterPrivateScript\":false},\"assertions\":{\"duration\":{\"duration\":0},\"jsr223\":[],\"xpathType\":\"xml\",\"regex\":[],\"document\":{\"type\":\"JSON\",\"data\":{\"json\":[],\"xml\":[]},\"enable\":true},\"xpath2\":[],\"jsonPath\":[]},\"postProcessor\":{\"jsrEnable\":true,\"scriptLanguage\":\"beanshell\"},\"preStepProcessor\":{\"jsrEnable\":true,\"scriptLanguage\":\"beanshell\"}}","hosts":None,"currentProjectId":"45741adb-9867-4610-84c8-54f699e3ebbd","uploadIds":[],"variablesFilesIds":[]}
...
def main(domain: str, access_key: str, secret_key: str, project_name: str, test_plan_name: str, env_name: str,
         ...
         manager_download, upgrade_manager_package, upgrade_manager_download, host_1, host_2, host_3, priority_network):
    ...
    m.update_env_1(project_name, project_id, env_name, env_id, doris_package_name, host_1, host_2, host_3, manager_download, manager_package, doris_download,
...
if __name__ == '__main__':
    ...
    main(endpoint, api_key, api_secret, project_name, test_plan_name, env_name, doris_package_name, doris_download,
         ...
         upgrade_manager_download, host_1, host_2, host_3, priority_network)
